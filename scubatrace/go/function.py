...
from .statement import GoBlockStatement, SimpleStatement
...
class GoFunction(Function, GoBlockStatement):
    ...
    def __find_next_nearest_stat(self, stat: Statement) -> Statement | None:
        ...
        if index == len(parent_statements) - 1:
            ...
            if stat.parent.node.type in language.GO.loop_statements:
                return stat.parent
            else:
                ...
                match type:
                    case "continue_statement":
                        ...
                        while (
                            ...
                            and loop_stat.node.type not in language.GO.loop_statements
